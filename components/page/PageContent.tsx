        ...
        >
          <div className="relative aspect-square w-full h-full overflow-hidden rounded-md shadow-md border border-neutral-500/20">
            ...
            <div className="absolute inset-0 flex items-end justify-start p-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300" aria-hidden="true">
              <div className="rounded-full bg-white dark:bg-neutral-600 bg-opacity-10 text-center flex items-center justify-center text-sm font-medium backdrop-blur backdrop-filter z-50 h-8 w-8 p-2">
                <PlayIcon className="h-3 w-3 text-neutral-900 dark:text-white" />
              </div>
            </div>
          </div>
